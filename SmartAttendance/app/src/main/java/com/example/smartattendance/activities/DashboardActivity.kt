...
class DashboardActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isTeacher = sessionManager.getRole().equals("TEACHER", ignoreCase = true)
    ...
    private fun configureRoleUi() {
        binding.fabJoinCourse.contentDescription = "Create Course"
        binding.tabEnrolled.visibility = android.view.View.GONE
        binding.tabTeaching.text = "Teaching"
    }
    ...
    private fun setupRecyclerView() {
        binding.coursesRecyclerView.apply {
            ...
            courseAdapter = CourseAdapter(emptyList()) { course ->
                // Handle course click
                val intent = Intent(this@DashboardActivity, CourseDetailActivity::class.java)
                intent.putExtra("courseId", course.id)
                intent.putExtra("courseName", course.courseName)
                intent.putExtra("teacherName", sessionManager.getUsername() ?: "Professor")
